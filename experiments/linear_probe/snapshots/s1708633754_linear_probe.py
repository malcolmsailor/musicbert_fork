        ...
        for epoch_i in range(train_config.n_epochs):
            ...
            with torch.no_grad():
                for i in pbar:
                    ...
                    metrics["loss"]["valid"].append(loss.item())
                    pbar.set_postfix({"valid_loss": avg_list(metrics["loss"]["valid"])})
        result = "end"
