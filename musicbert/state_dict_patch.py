...
def upgrade_state_dict_named2(self, state_dict, name):
    prefix = name + "." if name != "" else ""
...
def upgrade_state_dict_named3(self, state_dict, name):
    prefix = name + "." if name != "" else ""
...
RobertaModel.upgrade_state_dict_named = upgrade_state_dict_named3
